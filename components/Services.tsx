...
const services: Service[] = [
  {
    ...
    threeColor: "#38bdf8",
    tagAccent: "text-sky-600", tagBg: "bg-sky-50", tagBorder: "border-sky-100",
  },
  {
    ...
    threeColor: "#22d3ee",
    tagAccent: "text-cyan-600", tagBg: "bg-cyan-50", tagBorder: "border-cyan-100",
  },
  {
    title: "Cloud",
    titleJa: "クラウド",
    ...
    threeColor: "#60a5fa",
    tagAccent: "text-blue-600", tagBg: "bg-blue-50", tagBorder: "border-blue-100",
  },
  {
    title: "Mobile",
    titleJa: "モバイル開発",
  ...
  },
  {
    ...
    threeColor: "#f472b6",
    tagAccent: "text-pink-600", tagBg: "bg-pink-50", tagBorder: "border-pink-100",
  },
  {
    title: "Consulting",
    titleJa: "コンサルティング",
    ...
    threeColor: "#fbbf24",
    tagAccent: "text-amber-600", tagBg: "bg-amber-50", tagBorder: "border-amber-100",
  },
];
  ...
  return (
    <section id="service" className="section-padding relative overflow-hidden bg-white">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute bottom-0 left-1/4 w-[400px] h-[400px] bg-sky-100/40 rounded-full blur-[100px]" />
      </div>

      <div ref={ref} className="max-w-7xl mx-auto px-6">
        <div className="mb-16 text-center">
          <motion.p initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} className="text-xs tracking-[0.3em] text-sky-500 mb-4 uppercase">Service</motion.p>
          <motion.h2 initial={{ opacity: 0, y: 28 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6, delay: 0.1 }} className="text-3xl md:text-5xl font-bold text-slate-900 mb-3">
            What We Do
          </motion.h2>
          <motion.p initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ delay: 0.2 }} className="text-slate-400 text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {services.map((s, i) => (
            ...
            >
              <div className={`w-11 h-11 rounded-xl bg-gradient-to-br from-slate-50 to-slate-100 border ${s.border} flex items-center justify-center mb-5 ${s.accent} group-hover:scale-110 transition-transform duration-300`}>
                {s.icon}
              </div>
              <h3 className="text-slate-900 font-bold text-lg mb-1">{s.title}</h3>
              <p className="text-slate-400 text-[11px] mb-2 tracking-wide">{s.titleJa}</p>
